...
def simulated_annealing(init_state, energy_func, get_neighbor_func, temp_schedule):
    state = init_state
...
end_temp = 0.1
temp_factor = 0.99
temp_schedule = [start_temp * (temp_factor ** i) for i in range(int(math.log(end_temp / start_temp, temp_factor)))]

best_schedule, best_energy = simulated_annealing(init_state, energy_func, get_neighbor_func, temp_schedule)
...
print(f"Best energer: {best_energy)")
